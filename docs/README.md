...
![Spielstart – leerer Galgen und verdecktes Wort](docs/docs/screenshots/01_spielstart.png.png)
...
![Gewinn-Dialog](docs/docs/screenshots/04_gewonnen_dialog.png.png)  
![Verlust-Dialog und Totenkopf-Grafik](docs/docs/screenshots/05_verloren_dialog.png.png)  
![Fehlermeldung bei ungültiger Eingabe](docs/docs/screenshots/06_fehler_eingabe.png.png)  
